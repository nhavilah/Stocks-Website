...
export function Stocks() {
  ...
  useEffect(() => {
    let url = ``;
    if (id !== "null") {
      url = `https://172.22.25.101/stocks/symbols?industry=${id}`;
    } else {
      url = `https://172.22.25.101/stocks/symbols`;
    }
  ...
  return (
    ...
    >
      ...
      <div className="errorMessage">
        {error ? <p>Industry Sector "{id}" Not Found</p> : null}
      </div>
      <h3>Click On A Row To Inspect The Company</h3>
      <div>
        {!token ? (
          <p>Login To See Stock History For The Selected Company</p>
        ) : (
            <p>
